...
<div class=" row"><div class=" col1"><center><img id="ligma-balls" src="https://files-servleteer-vercel-app-six.vercel.app/typescripts/deez.webp" title="Deez Nuts 🥜" style="
    border-radius: 1vmax;
    filter: drop-shadow(2px 4px 6px black);
    height: 30vmin;
    width: 30vmin;
"></img></center><br><center><i>"TypeScript is blazingly fast"</i></center><br><center>-Nutflix</center><br></div><div class=" col1"><center><img src="https://files-servleteer-vercel-app-six.vercel.app/typescripts/ligma.webp" title="ligma balls 👅" style="
    border-radius: 1vmax;
    filter: drop-shadow(2px 4px 6px black);
    height: 30vmin;
    width: 30vmin;
"></img></center><br><center><i>"The best crutches I've ever used"</i></center><br><center>-Ligma</center><br></div><div class=" col1"><center><img src="https://files-servleteer-vercel-app-six.vercel.app/typescripts/svelte.jpeg" title="Svelter? I barely know her. 🌽" style="
    border-radius: 1vmax;
    filter: drop-shadow(2px 4px 6px black);
    height: 30vmin;
    width: 30vmin;
